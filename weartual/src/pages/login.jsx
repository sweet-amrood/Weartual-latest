...
const Login = ({ onLogin }) => {
  ...
  const handleGoogleLogin = () => {
    ...
    // Placeholder until backend Google OAuth endpoint is added.
    setTimeout(() => {
      setError('Google login is not connected to backend yet.');
      setIsSubmitting(false);
    }, 1000);
  };
                ...
                <Box>
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 1 }}>
                    <Button
                      ...
                      sx={{ textTransform: 'none', fontSize: '0.875rem', fontWeight: 600 }}
                    >
                      Forgot?
                    </Button>
                  </Box>
